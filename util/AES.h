...
namespace util {
   ...
   * @see http://www.lomont.org/Software/Misc/AES/AES.php
   */
  ...
  class AES
    ...
    public:
       ...
       * On non-embedded systems, it if fails, throws the string "Tables failed to initialize"
       */
      AES();
       ...
       */
      void SetParameters(int keylength = 128, int blocklength = 128);
